...
const Navbar = () => {
    ...
    {
      user && isAdmin && <li className="font-bold uppercase"><Link to='/Dashboard/adminhome'>Dashboard</Link></li>
    }
    {
      user && !isAdmin && <li className="font-bold uppercase"><Link to='/Dashboard/userhome'>Dashboard</Link></li>
    }
      ...
      <div className="navbar bg-orange-600 max-w-screen-xl text-white">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-orange-600 rounded-box w-52">
              {navItems}
            </ul>
          </div>
          <Link to='/'><a className=" text-xl font-bold uppercase italic">SurveyPolling</a></Link>
        </div>
